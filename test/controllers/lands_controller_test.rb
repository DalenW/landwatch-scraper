...
class LandsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create land" do
    assert_difference("Land.count") do
      post lands_url, params: { land: { price: @land.price, site: @land.site, site_path: @land.site_path } }
    end
  ...
  test "should update land" do
    patch land_url(@land), params: { land: { price: @land.price, site: @land.site, site_path: @land.site_path } }
